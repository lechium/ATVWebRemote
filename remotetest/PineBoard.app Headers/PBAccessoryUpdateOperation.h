...
- (void).cxx_destruct;	// IMP=0x0000000100054e7c
- (void)stepRunning:(id)arg1 deviceClass:(id)arg2 progress:(double)arg3 overallProgress:(double)arg4 info:(id)arg5;	// IMP=0x0000000100054bb4
- (void)stepComplete:(id)arg1 deviceClass:(id)arg2 successful:(_Bool)arg3 info:(id)arg4 error:(id)arg5;	// IMP=0x00000001000544ec
- (void)deviceClassAttached:(id)arg1;	// IMP=0x0000000100054390
- (void)_performUpdateSequence;	// IMP=0x0000000100053fa8
- (void)_setupMobileAccessoryUpdater;	// IMP=0x0000000100053bf4
- (void)main;	// IMP=0x00000001000537d0
