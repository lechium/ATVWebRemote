...
- (void)requestPresentationWithInfo:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100091fec
- (void)invalidate;	// IMP=0x0000000100091fe8
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x0000000100091f5c
- (id)init;	// IMP=0x0000000100091f44
